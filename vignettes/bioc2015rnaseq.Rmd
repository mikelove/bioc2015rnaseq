...
* [Loading gene annotations](#gene) (GenomicFeatures)
* [Creating an RNA-seq count table](#count) (GenomicAlignments, Rsubread)
* [Exploratory analysis and visualization](#eda) (DESeq2)
...
* Examining RNA-seq alignments (GenomicAlignments, Gviz)
...
values as a count matrix by counting the aligned fragments, perform
exploratory data analysis (EDA) and differential gene expression
testing, and annotation/export of results.
...
Our aim in this workflow is to identify difference due to
treatment, compared to control samples, while controlling for
the differences across cell line.
...
We need to read in the gene model which will be used for
...
# Annotation packages to add gene names
